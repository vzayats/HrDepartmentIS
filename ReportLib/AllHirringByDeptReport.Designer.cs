namespace ReportLib
{
    partial class AllHirringByDeptReport
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.numberOfWorkersCaptionTextBox.Value = "Прийнято за увесь час";
            // 
            ...
            this.textBox1.Value = "Всього працівників:";
            // 
            ...
            this.titleTextBox.Value = "Прийнято на роботу працівників по підрозділах(всього за увесь час)";
            // 
            // detail
            // 
