namespace ReportLib
{
    partial class DepartmentInfoReport
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.headCaptionTextBox.Value = "Начальник";
            // 
            ...
            this.officeCaptionTextBox.Value = "№ кабінету";
            // 
            ...
            this.phoneNumberCaptionTextBox.Value = "Телефон";
            // 
    ...
    " Head, office, PhoneNumber\r\nFROM            Department";
            ...
            this.titleTextBox.Value = "Інформація про підрозділи";
            // 
            // reportFooter
            // 
