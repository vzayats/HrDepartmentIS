namespace ReportLib
{
    ...
    /// <summary>
    /// Summary description for StaffListReport.
    /// </summary>
    public partial class StaffListReport : Telerik.Reporting.Report
    {
        public StaffListReport()
        {
            //
            ...
            this.barcode1.Value = "StaffList. Date of creation: " + DateTime.Now;
