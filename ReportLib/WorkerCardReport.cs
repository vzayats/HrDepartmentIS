namespace ReportLib
{
    ...
    /// <summary>
    /// Summary description for WorkerCardReport.
    /// </summary>
    public partial class WorkerCardReport : Telerik.Reporting.Report
    {
        public WorkerCardReport()
        {
            //
            ...
            this.barcode1.Value = "WorkerCard. Date of creation: " + DateTime.Now;
